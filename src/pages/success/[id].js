  ...
  return  (
    <PageWrapper>
      ...
      <p className='font-bold text-center'>Gracias por tu pago!</p>
        <p className='text-center mb-2'>Puedes ver tu transaccion en el escaner de la blockchain {network_chosen.name} </p>
        <button className='bg-green-1 text-white p-2 rounded-md shadow-sm' onClick={navigateToExplorer}>
          Link al Scanner
        </button>
        </div>
      }
